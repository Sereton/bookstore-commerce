sc# This file is auto-generated from the current state of the database. Instead
...
ActiveRecord::Schema.define(version: 0) do
  ...
  create_table "authors", primary_key: "author_id", id: :integer, default: -> { "nextval('actor_actor_id_seq'::regclass)" }, force: :cascade do |t|
...
#   Unknown type 'mpaa_rating' for column 'rating'
  ...
  add_foreign_key "film_actor", "author", column: "actor_id", primary_key: "author_id", name: "film_actor_actor_id_fkey", on_update: :cascade, on_delete: :restrict
